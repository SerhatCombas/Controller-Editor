...
from src.shared.components.translational import MechanicalGround
from src.shared.probes import BaseProbe
from src.shared.engine.output_kind import (
    OutputKind,
    QK_ACCELERATION,
    QK_DISPLACEMENT,
    QK_SPRING_FORCE,
...
if TYPE_CHECKING:
    ...
    from src.features.SystemModelingModule.canvas.component_system import CanvasVisualComponent, CanvasWireConnection
...
class CanvasCompiler:
    ...
    def compile(
        ...
        for cv in components:
            ...
            from src.features.SystemModelingModule.canvas.component_system import ComponentIoRole
    ...
    def _create_core_component(
        ...
        """
        from src.features.SystemModelingModule.canvas.component_system import COMPONENT_CATALOG
