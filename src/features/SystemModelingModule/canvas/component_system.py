...
if TYPE_CHECKING:
    ...
    from src.features.SystemModelingModule.canvas.visual_contract import ComponentVisualContract

from PySide6.QtCore import QPointF, QRectF, Qt
from PySide6.QtGui import QColor, QPainter, QPainterPath, QPen
from PySide6.QtSvg import QSvgRenderer

from src.features.SystemModelingModule.canvas.electrical_contracts import (
    CAPACITOR_CONTRACT,
...
from src.features.SystemModelingModule.canvas.translational_contracts import (
    DAMPER_CONTRACT,
    FIXED_CONTRACT,
    MASS_CONTRACT,
    SPRING_CONTRACT,
...
class CanvasVisualComponent:
    ...
    def transformed_connector_ports(self, rect: QRectF) -> list[tuple[ConnectorPortDefinition, QPointF]]:
        ...
        if contract is not None:
            from src.features.SystemModelingModule.canvas.visual_contract import ContractRenderer
...
def build_component_catalog() -> dict[str, ComponentVisualSpec]:
    from src.shared.components.translational import Damper, Mass, MechanicalGround, Spring, Wheel
    from src.shared.components.translational.sources import RandomRoad, StepForce
    return {
