...
from src.features.SystemModelingModule.canvas.component_system import (
...
from src.features.SystemModelingModule.canvas.scene_animation_mapper import SceneAnimationContext, SceneAnimationMapper, infer_workspace_template
...
class ModelCanvas(QWidget):
    ...
    def _get_default_params(component) -> dict[str, float]:
        ...
        if not registry_name:
            return {}
        try:
            from src.shared.utils.registry import registry as default_registry
