...
Usage::
    ...
    from src.shared.utils.registry import registry
...
# Base path for SVG symbols — lives under src/shared/symbols/
_SYMBOLS_DIR = Path(__file__).resolve().parent.parent / "symbols"
...
def _register_defaults() -> None:
    ...
    # === Electrical ===
    from src.shared.components.electrical.resistor import Resistor
    from src.shared.components.electrical.capacitor import Capacitor
    from src.shared.components.electrical.inductor import Inductor
    from src.shared.components.electrical.ground import ElectricalGround
    from src.shared.components.electrical.source import (
    ...
    # === Translational ===
    # NOTE: These use the OLD symbolic-pipeline classes from app/core/models/translational/
    # (not the simpler canvas-pipeline classes in src/shared/components/translational/).
    # The old classes have add_one_port_pair/_setup/symbolic_equations() which the
    # reducer pipeline depends on. They coexist with the src/ classes.
