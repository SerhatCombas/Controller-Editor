"""Legacy application state dataclasses (pre-AppStateV2).

These were the original quarter-car-era state classes.
Still used by ControllerDesignModule and old panels.
"""
